...
- Generally, as the carat increases, the price also increases.
- There is not a clean correlation between carats and price. There is no
  single curve between carats and price.
...
- There is not a clean correlation between carats and price. There is no
  single curve between carats and price.
- The cut helps explain the variation in the price because generally
  higher quality cuts like “Ideal” are more expensive than lower quality
  cuts like “Fair.”
