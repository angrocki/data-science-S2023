...
-   Generally as the thickness increases the elastic modulus decreases. This is not a clean or signficant correlation between the thickness and elastic modulus since the thickness at 0.064 does not match the trend of the other 3 thickness measurements.
...
-   Does this graph support or contradict the claim above?
    ...
    -   I don't believe the evidence is conclusive because certain densities do not follow the trend. I believe more data needs to be taken to conclusively contradict or support the claim.
