...
-   Was your sample size $n$ large enough? Why do you say that?
    -   Yes, I chose 100,000 which produced a mean that is 3.14 and had a small confidence interval. I started at 1000 and increases by 10x to pick the number. A lower sample sizes results in a mean that is not 3.14 and a large confidence interval. In addition, the use case was estimating pi and learning about the Monte Carlo method which does not have the same confidence level and sample size as a safety use case.
