...
-   To what extent can you tell what shape the distribution of the data has?
    -   The data looks vaguely like normal distribution with a few exceptions including a peak towards the left.
-   Assuming the scopus is the strength of an individual part made from this aluminum alloy, is the observed variability real or induced?
    -   The observed variability could be both real and induced since the variability could be in either the material or measurement of the materiel.
...
-   Can you *confidently* conclude that `POF < 0.03`? Why or why not?
    -   Yes because the POF and POF interval was calculated with 100,000 points which both fell below 0.03.
...
-   With the scopus as the `POF`, would uncertainty due to *limited physical tests* be induced or real?
    -   Both because the uncertainty can be from the data and data measurement.
...
-   Does the confidence interval above account for uncertainty arising from *limited physical tests* (`df_samples`)? Why or why not?
    -   No because it still uses the same data set that had limited physical tests.
-   Can you confidently conclude that `POF < 0.03`? Why or why not?
